...
fun CGFloat(number: Number): Double = Double(number = number)
fun CGFloat(number: UByte): Double = Double(number = number)
fun CGFloat(number: UShort): Double = Double(number = number)
fun CGFloat(number: UInt): Double = Double(number = number)
fun CGFloat(number: ULong): Double = Double(number = number)
fun CGFloat(string: String): Double? = Double(string = string)
