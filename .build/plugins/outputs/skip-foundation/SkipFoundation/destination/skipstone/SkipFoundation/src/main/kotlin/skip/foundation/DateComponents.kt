...
class DateComponents: Codable, MutableStruct {
    ...
    internal constructor(fromCalendar: Calendar, in_: TimeZone? = null, from: Date? = null, to: Date? = null, with: Set<Calendar.Component>? = null) {
        ...
        platformCal.timeZone = this.timeZone?.platformValue ?: platformCal.timeZone
    ...
    internal fun createCalendarComponents(timeZone: TimeZone? = null): java.util.Calendar {
        ...
        val matchtarget_0 = timeZone ?: this.timeZone
        ...
        val matchtarget_1 = this.year
        if (matchtarget_1 != null) {
            val year = matchtarget_1
            cal.set(java.util.Calendar.YEAR, year)
        } else {
            cal.set(java.util.Calendar.YEAR, 0)
        }
        val matchtarget_2 = this.month
        if (matchtarget_2 != null) {
            val month = matchtarget_2
        ...
        val matchtarget_3 = this.day
        if (matchtarget_3 != null) {
            val day = matchtarget_3
            cal.set(java.util.Calendar.DATE, day) // i.e., DAY_OF_MONTH
        } else {
            cal.set(java.util.Calendar.DATE, 1)
        }
        val matchtarget_4 = this.hour
        if (matchtarget_4 != null) {
            val hour = matchtarget_4
            cal.set(java.util.Calendar.HOUR_OF_DAY, hour)
        } else {
            cal.set(java.util.Calendar.HOUR_OF_DAY, 0)
        }
        val matchtarget_5 = this.minute
        if (matchtarget_5 != null) {
            val minute = matchtarget_5
            cal.set(java.util.Calendar.MINUTE, minute)
        } else {
            cal.set(java.util.Calendar.MINUTE, 0)
        }
        val matchtarget_6 = this.second
        if (matchtarget_6 != null) {
            val second = matchtarget_6
            cal.set(java.util.Calendar.SECOND, second)
        } else {
            cal.set(java.util.Calendar.SECOND, 0)
        }
        val matchtarget_7 = this.nanosecond
        if (matchtarget_7 != null) {
            val nanosecond = matchtarget_7
