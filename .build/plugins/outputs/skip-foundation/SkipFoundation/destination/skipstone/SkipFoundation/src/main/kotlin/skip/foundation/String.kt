...
fun String(localized: StringLocalizationValue, table: String? = null, bundle: Bundle? = null, locale: Locale = Locale.current, comment: String? = null): String {
    ...
    val (_, locfmt, _) = (bundle?.localizedInfo(forKey = key, value = null, table = table) ?: Triple("", key.kotlinFormatString, null)).sref()
...
fun String(localized: String, table: String? = null, bundle: Bundle? = null, locale: Locale? = null, comment: String? = null): String {
    val key = localized
